  ...
  return (
    <>
      ...
      <div className="desktop-shell">
        ...
        <main className="main-content">
          <div className="partner-detail-page">
            <div className="partner-detail-hero" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1526367790999-0150786686a2?w=1200&q=80)' }}>
              <div className="partner-detail-overlay"></div>
              <div className="partner-detail-hero-content">
                <div className="partner-detail-icon">🛵</div>
                <h1>Food Delivery Drivers</h1>
                <p>Deliver food and earn with flexible hours</p>
              </div>
            </div>
            ...
            <div className="partner-detail-content">
              <div className="partner-detail-section">
                <h2>Overview</h2>
                <p>Reach thousands of consumers on Kinnect, while offering greater convenience and rewards to your existing customers. Use bikes, motorcycles, or cars to deliver delicious meals across Guyana and earn on your own schedule.</p>
              </div>
              ...
              <div className="partner-detail-section">
                ...
                <div className="partner-benefits-list">
                  <div className="partner-benefit-item">
                    ...
                    <div>
                      <h4>Earn Per Delivery</h4>
                      <p>Make $300-$800+ per delivery with tips</p>
                    </div>
                  </div>
                  <div className="partner-benefit-item">
                    <span className="partner-benefit-check">✓</span>
                    <div>
                      <h4>Use Any Vehicle</h4>
                      <p>Bike, motorcycle, or car - your choice</p>
                    </div>
                  </div>
                  <div className="partner-benefit-item">
                    <span className="partner-benefit-check">✓</span>
                    <div>
                      <h4>Daily Payouts</h4>
                      <p>Cash out your earnings anytime</p>
                    </div>
                  </div>
                  <div className="partner-benefit-item">
                    <span className="partner-benefit-check">✓</span>
                    <div>
                      ...
                      <p>Earn extra during busy times</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="partner-detail-section">
                ...
                <ul className="partner-requirements-list">
                  ...
                  <li>Bike, motorcycle, or car</li>
                  <li>Smartphone with GPS and data</li>
      ...
      <header className="mobile-header">
        ...
        <h1 style={{ fontSize: '16px', fontWeight: 800 }}>Food Delivery</h1>
        <div style={{ width: '40px' }}></div>
      </header>

      <div className="mobile-content">
        <div className="partner-detail-page">
          <div className="partner-detail-hero" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1526367790999-0150786686a2?w=800&q=80)' }}>
            <div className="partner-detail-overlay"></div>
            <div className="partner-detail-hero-content">
              <div className="partner-detail-icon">🛵</div>
              <h1>Food Delivery Drivers</h1>
          ...
          <div className="partner-detail-content">
            <div className="partner-detail-section">
              <h2>Overview</h2>
              <p>Reach thousands of consumers on Kinnect. Use bikes, motorcycles, or cars to deliver meals and earn on your schedule.</p>
            </div>
            ...
            <div className="partner-detail-section">
              ...
              <ul className="partner-requirements-list">
                <li>Age 18 or older</li>
                <li>Valid ID or license</li>
                <li>Bike, motorcycle, or car</li>
                <li>Smartphone with GPS</li>
                <li>Delivery bag (provided)</li>
              </ul>
            </div>
