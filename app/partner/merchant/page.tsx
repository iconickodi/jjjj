...
export default function PartnerMerchantPage() {
  ...
  return (
    <>
      ...
      <div className="desktop-shell">
        ...
        <main className="main-content">
          <div className="partner-detail-page">
            <div className="partner-detail-hero" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1556742044-3c52d6e88c62?w=1200&q=80)' }}>
              <div className="partner-detail-overlay"></div>
              <div className="partner-detail-hero-content">
                <div className="partner-detail-icon">🏪</div>
                <h1>Merchant Partner</h1>
                <p>Grow your business with Kinnect</p>
              </div>
            </div>
            ...
            <div className="partner-detail-content">
              <div className="partner-detail-section">
                <h2>Overview</h2>
                <p>Reach thousands of consumers on Kinnect, while offering greater convenience and rewards to your existing customers. Whether you run a restaurant, grocery store, or retail shop - expand your reach and boost sales with our platform.</p>
              </div>
                ...
                <div className="partner-benefits-list">
                  <div className="partner-benefit-item">
                    ...
                    <div>
                      ...
                      <p>Access thousands of active users looking for your products</p>
                    </div>
                  </div>
                  <div className="partner-benefit-item">
                    <span className="partner-benefit-check">✓</span>
                    <div>
                      ...
                      <p>Streamlined dashboard to manage all orders in one place</p>
                    </div>
                  </div>
                  <div className="partner-benefit-item">
                    <span className="partner-benefit-check">✓</span>
                    <div>
                      ...
                      <p>Featured placements and promotional campaigns</p>
                    </div>
                  </div>
                  <div className="partner-benefit-item">
                    <span className="partner-benefit-check">✓</span>
                    <div>
                      ...
                      <p>Track sales, customer preferences, and performance</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="partner-detail-section">
                ...
                <ul className="partner-requirements-list">
                  ...
                  <li>Physical storefront or commercial kitchen</li>
                  <li>Food safety certification (for restaurants)</li>
                  <li>Smartphone or tablet for order management</li>
      ...
      <header className="mobile-header">
        ...
        <h1 style={{ fontSize: '16px', fontWeight: 800 }}>Merchant Partner</h1>
        <div style={{ width: '40px' }}></div>
      </header>

      <div className="mobile-content">
        <div className="partner-detail-page">
          <div className="partner-detail-hero" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1556742044-3c52d6e88c62?w=800&q=80)' }}>
            <div className="partner-detail-overlay"></div>
            <div className="partner-detail-hero-content">
              <div className="partner-detail-icon">🏪</div>
              <h1>Merchant Partner</h1>
          ...
          <div className="partner-detail-content">
            <div className="partner-detail-section">
              <h2>Overview</h2>
              <p>Reach thousands of consumers on Kinnect. Expand your reach and boost sales for restaurants, groceries, and retail.</p>
            </div>
            ...
            <div className="partner-detail-section">
              ...
              <ul className="partner-requirements-list">
                ...
                <li>Physical storefront</li>
                <li>Food safety cert (restaurants)</li>
