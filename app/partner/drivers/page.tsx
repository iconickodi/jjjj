  ...
  return (
    <>
      ...
      <div className="desktop-shell">
        ...
        <main className="main-content">
          <div className="partner-detail-page">
            <div className="partner-detail-hero" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=1200&q=80)' }}>
              <div className="partner-detail-overlay"></div>
              <div className="partner-detail-hero-content">
                <div className="partner-detail-icon">🚗</div>
                <h1>Kinnect Drivers</h1>
            ...
            <div className="partner-detail-content">
              <div className="partner-detail-section">
                <h2>Overview</h2>
                <p>Reach thousands of consumers on Kinnect, while offering greater convenience and rewards to your existing customers. Join our network of professional drivers providing reliable taxi services across Guyana.</p>
              </div>
                ...
                <div className="partner-benefits-list">
                  <div className="partner-benefit-item">
                    ...
                    <div>
                      ...
                      <p>Keep up to 85% of your fares with transparent pricing</p>
                    </div>
                  </div>
                  <div className="partner-benefit-item">
                    <span className="partner-benefit-check">✓</span>
                    <div>
                      ...
                      <p>Work when you want - full-time or part-time</p>
                    </div>
                  </div>
                  <div className="partner-benefit-item">
                    <span className="partner-benefit-check">✓</span>
                    <div>
                      ...
                      <p>Get paid every week directly to your bank account</p>
                    </div>
                  </div>
                  <div className="partner-benefit-item">
                    <span className="partner-benefit-check">✓</span>
                    <div>
                      <h4>24/7 Support</h4>
                      <p>Dedicated driver support team always available</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <header className="mobile-header">
        ...
        <h1 style={{ fontSize: '16px', fontWeight: 800 }}>Kinnect Drivers</h1>
        <div style={{ width: '40px' }}></div>
      </header>

      <div className="mobile-content">
        <div className="partner-detail-page">
          <div className="partner-detail-hero" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=800&q=80)' }}>
            <div className="partner-detail-overlay"></div>
            <div className="partner-detail-hero-content">
              <div className="partner-detail-icon">🚗</div>
              <h1>Kinnect Drivers</h1>
          ...
          <div className="partner-detail-content">
            <div className="partner-detail-section">
              <h2>Overview</h2>
              <p>Reach thousands of consumers on Kinnect, while offering greater convenience and rewards to your existing customers.</p>
            </div>
